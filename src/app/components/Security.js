...
const Security = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-start gap-[8%] bg-[#09002a] px-[10%] pb-[8%] py-[5%]">
      <div data-aos="fade-up" className="pr-[10%] w-[90%] lg:w-[40%]">
        <img src="/assets/img2.png" className="w-full h-full" />
      </div>

      <div
        data-aos="fade-up"
        className="space-y-8 pt-[8%]  lg:pt-0 pb-[11%] lg:pb-0 ml-[40%] lg:ml-0 w-[60%]"
      >
        ...
        <p className="text-[18px] text-end lg:text-start leading-[30px] lg:w-[75%] text-white/70">
        ...
        <div className="relative">
          <img
            ...
            className="absolute lg:-top-40 -top-[200px] -left-[75%] lg:left-[60%]  "
          />
        </div>
      </div>
    </div>
